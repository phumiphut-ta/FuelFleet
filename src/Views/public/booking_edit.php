        ...
        <form action="/booking/update/<?= $booking['id'] ?>" method="POST" class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="border border-slate-800 rounded-2xl bg-slate-950/30 p-5 space-y-4">
                        <!-- Search field -->
                        ...
                        <div class="flex flex-wrap gap-1.5 min-h-[32px] p-2 bg-slate-900/30 border border-slate-850 rounded-xl">
                            <template x-if="selectedProvinces.length === 0">
                                <span class="text-[11px] text-slate-500 font-light italic px-2">ยังไม่ได้เลือกจังหวัดปลายทาง</span>
                            </template>
